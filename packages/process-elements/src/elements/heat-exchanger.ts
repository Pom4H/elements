...
<g class="tag-panel" data-detail="standard"><rect class="panel" x="96" y="204" width="168" height="28" rx="5"/><text class="tag" data-part="label" x="108" y="222">HX-101</text><text class="readout" data-part="readout" x="252" y="222" text-anchor="end">82 → 46 °C</text></g>
`,
  styles: `
:host{display:inline-block;width:360px;max-width:100%;aspect-ratio:3/2;color:var(--elements-ink,#dbe7f3);--eq-body:var(--elements-equipment-body,#31485a);--eq-stroke:var(--elements-equipment-stroke,#9aafbd);--eq-line:var(--elements-line,#8095a4);--eq-panel:var(--elements-panel,#0d1922);--eq-muted:var(--elements-muted,#7890a1);--eq-hot:var(--elements-hot,#8b7467);--eq-cold:var(--elements-process,#43bce8)}svg{width:100%;height:100%}.view{display:none}:host(:not([view])) .equipment-view,:host([view="equipment"]) .equipment-view,:host([view="flat"]) .flat-view,:host([view="pid"]) .pid-view{display:inline}.body{fill:var(--eq-body);stroke:var(--eq-stroke);stroke-width:2}.line,.coil,.head,.baffle{fill:none;stroke:var(--eq-line);stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.line.hot{stroke:var(--eq-hot)}.line.cold{stroke:var(--eq-cold)}.coil{stroke-width:2}.head,.baffle{stroke-width:1.5;opacity:.7}.status-outline{fill:none;stroke:transparent;stroke-width:3}.operation-dot{fill:var(--eq-muted)}.panel{fill:var(--eq-panel);stroke:var(--eq-line);stroke-width:1}.tag{fill:currentColor;font:700 12px/1 ui-monospace,monospace}.readout{fill:var(--eq-cold);font:750 10px/1 ui-monospace,monospace}:host([view="pid"]) .tag-panel .panel{fill:transparent;stroke:none}:host([view="pid"]) .tag-panel .readout{display:none}:host([data-state~="active"]) .operation-dot{fill:var(--elements-ok,#56e29a)}:host([status="warning"]) .status-outline{stroke:var(--elements-warning,#ffbe4a)}:host([status="alarm"]) .status-outline{stroke:var(--elements-alarm,#ff5c74)}:host([quality="stale"]) .readout{opacity:.62}:host([quality="bad"]) .readout{opacity:.26}:host([detail="symbol"]) [data-detail]{display:none}
`,
  attributes: {
